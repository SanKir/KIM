...
<body>
	<div class="wrapper">
		...
		<div>
		<div class="content54">
		<a href="myprofile.php"><input type="submit" value="Моя страница" class="button56"></a> <Br>
		<input type="submit" value="Новости" class="button56"><Br>
		<input type="submit" value="Мои фотографии" class="button56"><Br>
		<a href="messenger.php"><input type="submit" value="Мои сообщения" class="button56"></a><Br>
